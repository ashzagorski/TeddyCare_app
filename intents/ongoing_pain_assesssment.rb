intent "OngoingPainAssessment" do 
  ...
  ask("<speak>
    ...
    Pain in your #{ part } is no fun. We want to help you with that. How long have you been having this pain? Did it start today, a week ago or less, a month ago or less, six months ago or less, a year ago <break time='.5s'/> or less or over a year ago? </prosody></voice></speak>", ssml: true,  session_attributes: { visit_id: visit_id, part: part, response: response } )
end